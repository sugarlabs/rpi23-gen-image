...
Note: This version of the image builder is used to generate custom Sugar Debian images for the Raspberry pi 2 & 3. Please use the rpi3stretch-sugar or the rpi2stretch-sugar template to run the build process
